...
async function summarizeContent(content) {
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer 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', // Replace with your actual API key
